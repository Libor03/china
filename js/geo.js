...
let unesco = [
    ...
    {
        "id": "Longmen",
        "nazev": "Jeskyně Longmen",
        "vznik": "roce 316",
        "unes": 2000,
        "photo": "longman.jpg",
        "description": "Jeskyně a výklenky Longmen obsahují největší a nejpůsobivější sbírku čínského umění pozdních severních Wei a Tang Dynasties (316-907). Tato díla, zcela zasvěcená buddhistickému náboženství, představují vrchol čínského vyřezávání kamene.Jeskyně Longmen, umístěné na obou stranách řeky Yi na jih od starobylého hlavního města Luoyang, provincie Henan, zahrnují více než 2 300 jeskyní a výklenků vytesaných do strmých vápencových útesů v délce 1 km. Obsahují téměř 110 000 buddhistických kamenných soch, více než 60 stúp a 2 800 nápisů vytesaných na steles. Luoyang byl kapitál během pozdní severní Wei dynastie a brzy Tang dynastie, a nejintenzivnější období řezbářství se datuje od konce 5. století do poloviny 8. století. Nejstarší jeskyně, které mají být vyřezány na konci 5. a na počátku 6 tPo staletí v útesech West Hill patří Guyangdong a Tři jeskyně Binyang, všechny obsahující velké postavy Buddhy. Jeskyně Yaofangdong obsahuje 140 léčebných procedur pro různé nemoci a nemoci. Práce na sochařství v této jeskyni pokračovaly více než 150 let, což ilustrovalo změny v uměleckém stylu. Sochařské styly objevené v buddhistických jeskyních dynastie Tang v 7. a 8. století, zejména obří sochy v jeskyni Fengxiansi, jsou nejreprezentativnějším příkladem umění chrámů královských jeskyní, které napodobují umělci z různých regionů. . Dva sochařské umělecké styly, dřívější „styl střední Číny“ a později „velký styl tanga“, měly velký vliv v celé zemi a na celém světě.",
        "url": "http://whc.unesco.org/en/list/1003"
    }, {
        "id": "Lushan",
        "nazev": "Národní park Lushan",
        "vznik": "15. století",
        "unes": 1996,
        "photo": "lushan.jpg",
        "description": "Mount Lushan v Jiangxi je jedním z duchovních center čínské civilizace. Buddhistické a taoistické chrámy, spolu s památkami konfucianismu, v nichž učili nejvýznamnější mistři, se bez námahy prolínají do nápadně krásné krajiny, která inspirovala bezpočet umělců, kteří vyvinuli estetický přístup k přírodě nalezený v čínské kultuře. Mount Lushan leží v oblasti Jiujiang City, Jiangxi Province. Nemovitost národního parku Lushan zaujímá celkovou plochu 30 200 hektarů a jeho nejvyšší vrchol, vrchol Hanyang, je 1 474 metrů nad mořem. Mount Lushan ohraničený na severu řekou Yangtze a na jihu jezerem Poyang představuje nedílnou scénu řeky, kopce a jezera, jejíž krása přitahuje duchovní vůdce, učence, umělce a spisovatele již více než 2 000 let.",
        "url": "http://whc.unesco.org/en/list/778"
    }, {
        "id": "Mausoleum",
        "nazev": "Mauzoleum prvního císaře Qin",
        "vznik": "roce 145 před naším letopočtem",
        "unes": 1987,
        "photo": "mausoleum.jpg",
        "description": "Není pochyb o tom, že v tomto archeologickém nalezišti, které nebylo objeveno až v roce 1974, stále zbývají tisíce soch. Qin (d. 210 př. Nl), první sjednocovač Číny, je pohřben, obklopen slavnými terakotovými válečníky, v centru komplex navržený tak, aby odrážel urbanistický plán hlavního města, Xianyan. Všechny malé postavy jsou různé; se svými koňmi, vozy a zbraněmi jsou mistrovskými díly realismu a také velkého historického zájmu. Mauzoleum Qinshihuang se nachází na severním úpatí hory Lishan, 35 km severovýchodně od Xi'an, provincie Shaanxi. Hrobka císaře Qinshihuang, zakladatele první sjednocené říše v čínské historii během 3. století BCE. V roce 246 před naším letopočtem začíná hrobová hromada přežít do výšky 51,3 metrů v obdélníkovém, dvojstěnném výběhu orientovaném na sever-jih. Téměř 200 doprovodných boxů obsahujících tisíce životních terra cotta vojáků, terra cotta koní a bronzových vozů a zbraní - světově proslulý objev - spolu s pohřebními hrobkami a architektonickými pozůstatky celkem přes 600 míst v oblasti nemovitostí o rozloze 56,25 km2. Podle historičky Simy Qian (c. 145-95 BCE).",
        ...
        "unes": 1987,
        "photo": "lushan.jpg",
        "description": "Nachází se na strategickém místě podél hedvábné cesty, na křižovatce obchodu i náboženských, kulturních a intelektuálních vlivů. Jeskyně Mogao, vytesané do útesů nad řekou Dachuan, jihovýchodně od oázy Dunhuang v provincii Gansu, představují největší, nejbohatší a nejdelší použitý pokladní dům buddhistického umění na světě. Byl postaven v roce 366AD a představuje velký úspěch buddhistického umění od 4. do 14. století. V současné době je zachováno 492 jeskyní, ve kterých se nachází asi 45 000 metrů čtverečních nástěnných maleb a více než 2 000 malovaných plastik. Jeskyně 302 dynastie Sui obsahuje jednu z nejstarších a nejživějších scén kulturních výměn podél Hedvábné stezky, zobrazující velblouda tahajícího vozík typický pro obchodní mise té doby. Jeskyně 23 a 156 dynastie Tang ukazují dělníkům na polích a linii válečníků a v jeskyni 61 dynastie Song.",
